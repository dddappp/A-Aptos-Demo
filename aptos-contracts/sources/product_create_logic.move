module aptos_test_proj1::product_create_logic {
    use std::string::String;

    use aptos_test_proj1::product::{Self, Product};
    use aptos_test_proj1::product_created;

    //use sui::tx_context::TxContext;
    //use aptos_test_proj1::product_created;

    friend aptos_test_proj1::product_aggregate;
