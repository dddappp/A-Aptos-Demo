...
* Install JDK and Maven. The off-chain services generated by the tool currently use Java language.
...
After executing above command successfully, directories `aptos-contracts` and `aptos-java-service` should be added to local directory `/PATH/TO/test`.
